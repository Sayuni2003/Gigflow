...
import CategoryFilterBadge from "../components/gigs/CategoryFilterBadge";
import GigCard from "../components/gigs/GigCard";
import GigFiltersSidebar from "../components/gigs/GigFiltersSidebar";
    ...
    <div className="min-h-screen bg-bg-main">
      ...
      <div className="mx-auto max-w-7xl px-5 py-8">
        <nav className="text-sm text-text-secondary" aria-label="Breadcrumb">
          <Link to={ROUTES.home} className="hover:text-text-primary">
            Home
          </Link>
          <span className="mx-2">/</span>
          <span className="text-text-primary">Browse gigs</span>
        </nav>
